...
function Modal() {
    ...
    const uploadPost = async()=>{
        ...
        setLoading(true);
        //crea publicacines y añadelas al firestore  
        ...
        console.log("nuevo documento añadido mediante ID", docRef.id);
                            ...
                            <div>
                                    ...
                                    <div className="mt-3 text-center sm:mt-5">
                                        ...
                                        <div className="mt-2">
                                            <input
                                                ...
                                                type="text"
                                                ref={captionRef}
                                                placeholder="Pleace enter a caption"
                                            />
                                ...
                                <div className="mt-5 sm:mt-6">
                                    <button
                                        ...
                                        disabled:cursor-nooot-allowed hover:disabled:bg-gray-300"
                                        onClick={uploadPost}
                                    >
